...
static const std::map<int, DiscordApp> DISCORD_APPS = {
	...
	{0, {752165779117441075, "Online", "Offline", "ddnet_logo", "DDNet logo"}}, // DDNet
	{1, {1325361453988970527, "In-Game", "In-Menus", "tclient", "TClient"}}, // Tater
	{2, {1121238977228328970, "Online", "Offline", "cff_logo", "CFF logo"}}, // CFF
	{3, {1326161704043679845, "Online", "Offline", "ddnet_logo", "DDNet logo"}}, // KRX
	{4, {1337554226926321745, "Online", "Offline", "ddnet_logo", "DDNet logo"}}, // Zyro
};
